    ...
    <section class="section contact-section">
      <div class="container contact-inner">
        ...
        <div class="contact-info">
          ...
          <div class="contact-cards">
            <a href="tel:+255755794664" class="contact-card glass-card">
              ...
              <div>
                ...
                <span class="contact-card__value">+255 755 794 664</span>
              </div>
            </a>
            <a href="tel:+255616533644" class="contact-card glass-card">
              ...
              <div>
                ...
                <span class="contact-card__value">+255 616 533 644</span>
              </div>
            </a>
          ...
          <div class="contact-hours glass-card">
            <h4 class="contact-hours__title">Business Hours</h4>
            <div class="contact-hours__row" v-for="h in hours" :key="h.days">
              <span>{{ h.days }}</span>
          ...
          <div class="contact-form glass-card">
            ...
            <form v-else class="form" @submit.prevent="handleSubmit">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    placeholder="+255 or email address"
                  />
              ...
              <div class="form-group">
                ...
                <select v-model="form.service" class="form-input form-select" :class="{ error: errors.service }">
...
function validate(): boolean {
  ...
  if (!form.service) { errors.service = 'Please select a service.'; valid = false }
  if (form.message.trim().length < 10) { errors.message = 'Please write a bit more about your project.'; valid = false }
